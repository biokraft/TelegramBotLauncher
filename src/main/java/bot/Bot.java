...
public class Bot extends TelegramLongPollingBot {
    ...
    public int[] parseDate (String raw) {
        int[] result = new int[3]; String cache = ""; int arrIndex = 0;
    ...
    public void addCommand (String command, String answer) {
        commandData.writeLine(command);
        commandData.writeLine(answer);
        commandData.writeLine();
    }
